% FF_DOM.M      (Fonseca Fleming Dominance)
%
% This function implements the Fonseca Fleming Dominance.
%
...
%             
function ObjVal = ff_dom(MObjV,myswitch)
...
% Check size of Chrom and do the appropriate thing
   ...
   if Nind == 0
      ...
      if myswitch == 2
         ObjVal = ['FONSECA FLEMING dominance -' int2str(Dim)];
